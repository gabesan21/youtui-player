...
- **Delivery:** Kitty thumbnails render again: the sink transmits a derived PNG (kitty accepts RGB/RGBA/PNG only, not the JPEG cache), transmit is `a=t`, and Invalidate re-transmits after delete-all.
