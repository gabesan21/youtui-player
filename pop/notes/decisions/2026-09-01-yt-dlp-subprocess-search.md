...
- Git history: `git log -S 'yt-dlp' -- internal/search/invidious.go` shows `04fb5c4 feat: url manipulation`, `4a3f99c feat: persistent language`, `3812634 fix: text ui themes`, `14a2e7b fix: remove coments`, `af0a2b5 feat: tumbnail`, `795d5b5 feat: init repo`; `git log -S 'SearchVideos' -- internal/search/invidious.go` shows `14a2e7b` and `795d5b5`.
